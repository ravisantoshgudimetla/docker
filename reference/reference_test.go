...
func TestParseRepositoryInfo(t *testing.T) {
	...
	tcases := []tcase{
		{
			RemoteName:     "fooo/bar",
			NormalizedName: "docker.io/fooo/bar",
			FullName:       "docker.io/fooo/bar",
			AmbiguousName:  "",
			Hostname:       "docker.io",
		},
		{
			RemoteName:     "library/bar",
			NormalizedName: "docker.io/bar",
			FullName:       "docker.io/library/bar",
			AmbiguousName:  "index.docker.io/library/bar",
			Hostname:       "docker.io",
		},
		{
			RemoteName:     "fooo/bar",
		...
		},
		{
			...
			NormalizedName: "docker.io/ubuntu-12.04-base",
